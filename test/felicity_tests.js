...
describe('Felicity Example', () => {
    ...
    it('should return function keys', (done) => {
        ...
        expect(example.func).to.be.a.function();
    ...
    it('should return an object with null default', () => {
...
describe('Felicity EntityFor', () => {
    ...
    describe('Object', () => {
        ...
        it('should return an object without .strip\'ed keys', () => {
    ...
    describe('Skeleton Example', () => {
        ...
        it('should return an a hydrated valid instance', () => {
            ...
            expect(felicityExample.func).to.be.a.function();
